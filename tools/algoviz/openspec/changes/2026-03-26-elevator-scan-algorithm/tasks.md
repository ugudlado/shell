...
### [x] Task 1.1 [RED] — Write SCAN algorithm tests
...
### [x] Task 1.2 [GREEN] — Implement SCAN algorithm
...
### [x] Task 2.1 [RED] — Write UI structure tests
...
### [x] Task 2.2 [GREEN] — Build elevator page and styles
...
### [x] Task 2.3 [REFACTOR] — Polish UI and animation
...
### [x] Task 3.1 — Add navigation between algorithms
...
### [x] Task 3.2 — Final integration testing
