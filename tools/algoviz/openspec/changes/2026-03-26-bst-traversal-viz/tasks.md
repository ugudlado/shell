...
### Task 1.1: Create `bst-algorithm.js` — Pure BST Algorithm
...
### Task 1.2: Create `bst-algorithm.test.js` — Algorithm Tests
- **Why**: Validate correctness of insert, traversals, edge cases
- **Files**: Create `bst-algorithm.test.js`
- **Verify**: `npm test` passes with all BST tests green
...
### Task 2.1: Create `bst.html`, `bst.js`, `bst-style.css` — BST Page
...
### Task 2.2: Add nav links to ALL existing pages
