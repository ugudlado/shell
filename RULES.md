...
2. **Spec-first for OpenSpec work** — under `openspec/`, treat schemas, step YAML, and templates as the contract. Do not skip documented phases or gates without an explicit human decision.
