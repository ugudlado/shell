# complete workflow — bugfix

Identical step sequence to `feature-tdd/complete`. Steps execute in `order:` sequence.
Schema-specific override: `retrospective` (4) compares fix-plan predictions rather than spec predictions.
...
|     4 | retrospective     | Compare fix-plan predictions against actuals and write telemetry |
